...
urlpatterns = [
    ...
    path('view-publications/<int:key>', PublicationDetail.as_view(), name='view-publication-detail'),
    path('create-publications', PublicationCreateView.as_view(), name='create-publications'),
    ...
    path('collaborator/add/<int:project_id>/', AddCollaborator.as_view(), name='add-collaborator'),
    path('collaborator/delete/<int:pk>', DeleteCollaborator.as_view(), name='delete-collaborator'),
